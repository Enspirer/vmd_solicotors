<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ url('images/logo/vmd-logo-footer.png') }}" width="40" height="40" alt="CoreUI Logo">
        <img class="navbar-brand-minimized" src="{{ url('images/logo/vmd-logo-footer.png') }}" width="40" height="40" alt="CoreUI Logo">
    </a>
