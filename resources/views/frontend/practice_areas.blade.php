...
<section class="practice-areas hero-section" style="background: linear-gradient(to top, rgba(0, 0, 0, 1), rgba(0, 0, 0, 0.25)), url('../../images/practice-areas/hero-banner.png');">
    <div class="container">
