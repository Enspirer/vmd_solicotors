...
<section class="pai-section">
    <div class="container">
        <div class="header">Drafting and Document Review</div>
        <div class="content-block">
            <div class="row">
                <div class="col-lg-8">
                    <div class="title-block">
                        <div class="title">Drafting and Document Review <span>(subtitle here)</span></div>
                ...
                <div class="col-lg-4">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a href="{{route('frontend.drafting')}}" class="nav-link active">Drafting and Document Review</a></li>
